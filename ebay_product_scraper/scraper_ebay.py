...
class EbayScraper:
    def __init__(self, url):
        self.url = url
        self.file_name = 'index_selenium.html'
    ...
    def main(self):
        ...
        all_product_data = []
        for link in links:
            product_data = self.scrape_product_info(link)
            if product_data:
...
if __name__ == '__main__':
    scraper = EbayScraper('https://www.ebay.com/b/Canon-Digital-SLR-Cameras/31388/bn_661')
    scraper.main()
